"""Sequential plot for only steering.

This file is used for offline simulation for CARLA Data,
...
if args.cluster == 'yes':  # use GPU, in Laufwerk
    ...
    CNN_S_100 = SDIR + "CNN/steering/seed_100/"
    CNN_S_150 = SDIR + "CNN/steering/seed_150/"
    CNN_S_200 = SDIR + "CNN/steering/seed_200/"
    # define where CNN+LSTM models are saved.
    LSTM_S_100 = SDIR + "CNN+LSTM/steering/seed_100/"
    LSTM_S_150 = SDIR + "CNN+LSTM/steering/seed_150/"
    LSTM_S_200 = SDIR + "CNN+LSTM/steering/seed_200/"
    # define where CNN+GRU models are saved.
    GRU_S_100 = SDIR + "CNN+GRU/steering/seed_100/"
    GRU_S_150 = SDIR + "CNN+GRU/steering/seed_150/"
    GRU_S_200 = SDIR + "CNN+GRU/steering/seed_200/"
    # define where CNN+CTGRU models are saved.
    CTGRU_S_100 = SDIR + "CNN+CTGRU/steering/seed_100/"
    CTGRU_S_150 = SDIR + "CNN+CTGRU/steering/seed_150/"
    CTGRU_S_200 = SDIR + "CNN+CTGRU/steering/seed_200/"
    # define where CNN+NCP models are saved.
    NCP_S_100 = SDIR + "CNN+NCP/steering/seed_100/"
    NCP_S_150 = SDIR + "CNN+NCP/steering/seed_150/"
    NCP_S_200 = SDIR + "CNN+NCP/steering/seed_200/"
...
dev_cnn_s, dev_lstm_s, dev_gru_s, dev_ctgru_s, dev_ncp_s = \
    [], [], [], [], []
...
for j in sequence:
        ...
        if "timestamps" not in pic_name and \
            ...
            actions_ncp_2, hidden_state_ncp2 = \
                ncp2.evaluate_on_single_sequence(
                    states_rnn, hidden_state=hidden_state_ncp2
                )
            actions_ncp_3, hidden_state_ncp3 = \
                ncp3.evaluate_on_single_sequence(
                    states_rnn, hidden_state=hidden_state_ncp3
                )
            actions_average = \
    ...
    # len(s_truth) == len(s_p_CNN) == len(s_p_NCP_N) == len(s_p_NCP_A) == len(s_p_NCP_R)
    assert \
